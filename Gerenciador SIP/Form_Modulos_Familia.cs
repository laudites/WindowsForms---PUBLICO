...
{
    public partial class Form_Modulos_Familia : Form
    {
        ...
        public Form_Modulos_Familia(List<string> valorGerenciador, string login)
        {
            Login = login;
        ...
        private void Form_Modulos_Familia_Load(object sender, EventArgs e)
        {
            ...
            // Consulta SQL
            string consultaSql = "select * from Modelo_Familia_Eng";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0 && e.ColumnIndex >= 0)
            {
                ...
                string valorFamilia = dataGridView1.Rows[e.RowIndex].Cells["Resfriamento"].Value.ToString();
                textBox_linha.Text = valorLinha;
                textBox_familia.Text = valorFamilia;
        ...
        private void dataGridView1_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                string valorFamilia = linhaSelecionada.Cells["Resfriamento"].Value.ToString();
        ...
        private void button_confirmar_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(@"Data Source=" + Instancia + ";Initial Catalog=" + Banco + ";Persist Security Info=True;User ID=" + Usuario + ";Password=" + Senha))
            {
                ...
                {
                    string query = "insert into Modelo_Familia_Eng values (@Familia,@Linha,'Eletrofrio')";
                    using (SqlCommand cmd = new SqlCommand(query, con, transaction))
                    {
                        cmd.Parameters.AddWithValue("@Linha", textBox_linha.Text);
                        cmd.Parameters.AddWithValue("@Familia", textBox_familia.Text);
                        cmd.ExecuteNonQuery();
                    }
                    transaction.Commit();
                }
            ...
            con1.Open();
            string insert_log = $"insert into Log_eng values ('{Login}','Cadastro Familia','','','{textBox_linha.Text + ',' + textBox_familia.Text}','Criação de familia do expositor','{dataAtual}',NULL,NULL);";
            SqlTransaction transaction1 = con1.BeginTransaction();
            SqlCommand cmd1 = new SqlCommand(insert_log, con1, transaction1);
            cmd1.ExecuteNonQuery();
            transaction1.Commit();
            con1.Close();
            Form_Modulos_Familia_Load(sender, e);
        }
